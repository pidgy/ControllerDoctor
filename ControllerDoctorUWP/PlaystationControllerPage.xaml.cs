...
{
    public partial class PlaystationControllerPage : Page
    {
        ...
        private void Initialize()
        {
            ...
            Buttons[Ex_Button.Name] = new ButtonData(Ex_Button, (IController c) => { return true == c.ButtonAPressed() ? Press.DIRECTION.PRESSED : Press.DIRECTION.NONE; }, Ex_Button_Status);
            Buttons[Square_Button.Name] = new ButtonData(Square_Button, (IController c) => { return true == c.ButtonXPressed() ? Press.DIRECTION.PRESSED : Press.DIRECTION.NONE; }, Square_Button_Status);
            Buttons[Triangle_Button.Name] = new ButtonData(Triangle_Button, (IController c) => { return true == c.ButtonYPressed() ? Press.DIRECTION.PRESSED : Press.DIRECTION.NONE; }, Triangle_Button_Status);
            Buttons[Circle_Button.Name] = new ButtonData(Circle_Button, (IController c) => { return true == c.ButtonBPressed() ? Press.DIRECTION.PRESSED : Press.DIRECTION.NONE; }, Circle_Button_Status);
